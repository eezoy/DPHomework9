...
public class GoldAppraiser implements ArtifactVisitor {
    ...
    public void visit(Weapon weapon) {
        ...
        System.out.println("  Gold: Weapon  '" + weapon.getName() + "' -> " + appraisedValue + "g");
    }
    ...
    public void visit(Potion potion) {
        ...
        totalValue += appraisedValue;
        System.out.println("  Gold: Potion  '" + potion.getName() + "' -> " + appraisedValue + "g");
    }
    ...
    public void visit(Scroll scroll) {
        ...
        totalValue += appraisedValue;
        System.out.println("  Gold: Scroll  '" + scroll.getName() + "' -> " + appraisedValue + "g");
    }
    ...
    public void visit(Ring ring) {
        ...
        totalValue += appraisedValue;
        System.out.println("  Gold: Ring    '" + ring.getName() + "' -> " + appraisedValue + "g");
    }
    ...
    public void visit(Armor armor) {
        ...
        totalValue += appraisedValue;
        System.out.println("  Gold: Armor   '" + armor.getName() + "' -> " + appraisedValue + "g");
    }
}
